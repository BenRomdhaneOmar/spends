package com.benromdhane.omar.offroadsoft.turtlesandrabbits.spends.presentation.rest.router
...
import com.benromdhane.omar.offroadsoft.turtlesandrabbits.spends.presentation.rest.dto.toDateDTO
...
class SpendsRestTest private constructor(
    ...
    fun `add spend must return error if spend is invalid`() {
        this.readRouterTestClient
            ...
            .valueEquals(
                ...
                "com.benromdhane.omar.offroadsoft.turtlesandrabbits.spends.core.model.Spend.Error.ValueZeroOrNegative"
            )
            .expectHeader()
    ...
    fun `add spend must return error if spend is valid but date is invalid`() {
        this.readRouterTestClient
            ...
            .valueEquals(
                this.spendsSettings.headers!!.errors!!.codes,
                "com.benromdhane.omar.offroadsoft.turtlesandrabbits.spends.core.service.SpendsService.Error.Business.FutureSpend"
            )
            .expectHeader()
            .exists(this.spendsSettings.headers!!.errors!!.messages)
    }
